...
function textcolor(dark) {
	if (dark === true) {
		...
		style.setProperty('--color', '#1d1d1f');
	} else {
...
brbtn.addEventListener('click', function () {
	brconst.style.fontSize = '120px';
	brinput.value = 120;
});

nmbtn.addEventListener('click', function () {
	nmconst.style.fontSize = '80px';
	nminput.value = 80;
});

evbtn.addEventListener('click', function () {
	evconst.style.fontSize = '60px';
	evinput.value = 60;
});

posbtn.addEventListener('click', function () {
	imgconst.style.top = '160px';
	imgconst.style.left = '0';
	posinput.value = 0;
});
